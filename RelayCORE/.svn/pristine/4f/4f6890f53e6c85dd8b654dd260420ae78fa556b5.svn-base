/*************************************************************************
  ...
  Revisione: Novembre, 2016
	...
	Revisione: Gennaio, 2019
	 ...
	 Obiettivo:
	 	- Modifica per consentire la ritrattazione di fatti presenti nella base di conoscenza all'avvio del sistema.
...
writededfact(Stream,If):-
	...
	%- VARIANTE: inibisce il controllo per verificare se il nuovo fatto fosse gi� presente tra quelli iniziali. Variante collegata a "save_dedfact".
	%not(member(Idf,If)),
	%--------------------------------------------
...
save_dedfact :-
	...
	*/
	...
	%--------Modificato da De Filippis-Cafagna---
	%- VARIANTE: commentare per abilitare la ritrattazione dei fatti iniziali presenti nella base di conoscenza all'avvio del motore inferenziale
