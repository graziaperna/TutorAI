...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EXPLAINER CLASSIFICAZIONE DOCUMENTI %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
explainer(categoria_articol(Categoria),1,'L''articolo analizzato e'' un articolo che tratta di '+Categoria).
explainer(sotto_categoria_articol(SottoCategoria),1,'In particolare l''articolo tratta di '+SottoCategoria).


explainer(testata_nazional(corriere,sera),1,'La testata giornalistica individuata è il corriere della sera').
explainer(testata_nazional(fatto,fatto),1,'La testata giornalistica individuata è il fatto quotidiano').
explainer(testata_nazional(resto,carlino),1,'La testata giornalistica individuata è il resto del carlino').
explainer(testata_nazional(secolo,xix),1,'La testata giornalistica individuata è il secolo xix.').
explainer(testata_nazional(italia,oggi),1,'La testata giornalistica individuata è l''italia oggi.').
explainer(testata_nazional(gazzetta,mezzogiorno),1,'La testata giornalistica individuata è la gazzetta del mezzogiorno.').
explainer(testata_nazional(osservatore,romano),1,'La testata giornalistica individuata è l'' osservatore romano.').
explainer(testata_nazional(milano,finanza),1,'La testata giornalistica individuata è Milano Finanza.').
explainer(testata_nazional(secolo,italia),1,'La testata giornalistica individuata è il secolo italia').
explainer(testata_nazional(T),1,'La testata giornalistica individuata è '+T).
explainer(testata_internazional(T),1,'La testata giornalistica individuata è '+T).
explainer(testata_internazional(T,Y),1,'La testata giornalistica individuata è '+T+' '+Y).
explainer(date(D,M,Y),1,'La data individuata è '+D+' '+M+' '+Y).
explainer(entita_person(Nome,Cognome),1,'Individiduata la persona di nome: '+Nome +' '+Cognome).
explainer(luogo_italia(C,Y),1,'Individiduata il luogo italiano: '+C +' situato nella regione '+Y).
explainer(citta_europa(C),1,'Individiduata la città europea: '+C).
explainer(citta_mondo(C),1,'Individiduata la città mondiale: '+C).


%spiegazioni parole categorie cronaca
explainer(entita_generale_asserita_cronac(C,F),1,'Individuata l''entita generale di cronaca:'+C+' contenuta nella frase '+F).
explainer(oggetto_generale_asserito_cronac(C,F),1,'Individuata l''entita generale di cronaca:'+C+' contenuta nella frase '+F).
explainer(verbo_generale_asserito_cronac(C,F),1,'Individuata il verbo della categoria cronaca:'+C+' contenuta nella frase '+F).
explainer(entita_discriminante_asserita_furt(C,F),1,'Individuata l''entita discriminante di furto:'+C+' contenuta nella frase '+F).
explainer(oggetto_discriminante_asserito_furt(C,F),1,'Individuata l''entita discriminante di furto:'+C+' contenuta nella frase '+F).
explainer(entita_discriminante_asserita_omicidi(C,F),1,'Individuata l''entita discriminante di omicidio:'+C+' contenuta nella frase '+F).
explainer(oggetto_discriminante_asserito_omicidi(C,F),1,'Individuata l''entita discriminante di omicidio:'+C+' contenuta nella frase '+F).
explainer(entita_discriminante_asserita_terrorism(C,F),1,'Individuata l''entita discriminante di terrorismo:'+C+' contenuta nella frase '+F).
explainer(oggetto_discriminante_asserito_terrorism(C,F),1,'Individuata l''entita discriminante di terrorismo:'+C+' contenuta nella frase '+F).
explainer(entita_discriminante_asserita_terremot(C,F),1,'Individuata l''entita discriminante di terremoto:'+C+' contenuta nella frase '+F).
explainer(oggetto_discriminante_asserito_terremot(C,F),1,'Individuata l''entita discriminante di terremoto:'+C+' contenuta nella frase '+F).
explainer(entita_discriminante_asserita_mafi(C,F),1,'Individuata l''entita discriminante di mafia:'+C+' contenuta nella frase '+F).
explainer(oggetto_discriminante_asserito_mafi(C,F),1,'Individuata l''entita discriminante di mafia:'+C+' contenuta nella frase '+F).
explainer(entita_discriminante_asserita_corruzion(C,F),1,'Individuata l''entita discriminante di corruzione:'+C+' contenuta nella frase '+F).
explainer(oggetto_discriminante_asserito_corruzion(C,F),1,'Individuata l''entita discriminante di corruzione:'+C+' contenuta nella frase '+F).
explainer(relazione_cronac(S,V,O),1,'Individuata la relazione di cronaca con soggetto '+S+' verbo '+V+' oggetto '+O).

explainer(entita_asserita_cultur(C,F),1,'Individuata l''entita di cultura:'+C+' contenuta nella frase '+F).
explainer(oggetto_asserito_cultur(C,F),1,'Individuata l''entita di cultura:'+C+' contenuta nella frase '+F).
explainer(verbo_asserito_cultur(C,F),1,'Individuata il verbo della categoria cultura:'+C+' contenuta nella frase '+F).
explainer(relazione_cultur(S,V,O),1,'Individuata la relazione di cultura con soggetto '+S+' verbo '+V+' oggetto '+O).

explainer(entita_generale_asserita_economi(C,F),1,'Individuata l''entita generale di economia:'+C+' contenuta nella frase '+F).
explainer(oggetto_generale_asserito_economi(C,F),1,'Individuata l''entita generale di economia:'+C+' contenuta nella frase '+F).
explainer(entita_discriminante_asserita_economi(C,F),1,'Individuata l''entita discriminante di economia:'+C+' contenuta nella frase '+F).
explainer(oggetto_discriminanti_asserito_economi(C,F),1,'Individuata l''entita discriminante di economia:'+C+' contenuta nella frase '+F).
explainer(verbo_asserito_economi(C,F),1,'Individuata il verbo della economia cultura:'+C+' contenuta nella frase '+F).
explainer(relazione_economi(S,V,O),1,'Individuata la relazione di economia con soggetto '+S+' verbo '+V+' oggetto '+O).

explainer(entita_generale_asserita_mond(C,F),1,'Individuata l''entita generale di mondo:'+C+' contenuta nella frase '+F).
explainer(oggetto_generale_asserito_mond(C,F),1,'Individuata l''entita generale di mondo:'+C+' contenuta nella frase '+F).
explainer(entita_discriminante_asserita_mond(C,F),1,'Individuata l''entita discriminante di mondo:'+C+' contenuta nella frase '+F).
explainer(oggetto_discriminante_asserito_mond(C,F),1,'Individuata l''entita discriminante di mondo:'+C+' contenuta nella frase '+F).
explainer(verbo_asserito_mond(C,F),1,'Individuata il verbo di mondo :'+C+' contenuta nella frase '+F).
explainer(relazione_mond(S,V,O),1,'Individuata la relazione di mondo con soggetto '+S+' verbo '+V+' oggetto '+O).

explainer(entita_generale_asserita_politic(C,F),1,'Individuata l''entita generale di politica:'+C+' contenuta nella frase '+F).
explainer(oggetto_generale_asserito_politic(C,F),1,'Individuata l''entita generale di politica:'+C+' contenuta nella frase '+F).
explainer(entita_discriminante_asserita_politic(C,F),1,'Individuata l''entita discriminante di politica:'+C+' contenuta frase '+F).
explainer(oggetto_discriminante_asserito_politic(C,F),1,'Individuata l''entita discriminante di politica:'+C+' contenuta frase '+F).
explainer(verbo_asserito_politic(C,F),1,'Individuata il verbo di politica :'+C+' contenuta nella frase '+F).
explainer(relazione_politic(S,V,O),1,'Individuata la relazione di politica con soggetto '+S+' verbo '+V+' oggetto '+O).

explainer(entita_generale_asserita_spor(C,F),1,'Individuata l''entita generale di sport:'+C+' contenuta nella frase '+F).
explainer(oggetto_generale_asserito_spor(C,F),1,'Individuata l''entita generale di sport:'+C+' contenuta nella frase '+F).
explainer(verbo_asserito_spor(C,F),1,'Individuata il verbo della categoria sport:'+C+' contenuta nella frase '+F).
explainer(entita_discriminante_asserita_calci(C,F),1,'Individuata l''entita discriminante di calcio:'+C+' contenuta nella frase '+F).
explainer(oggetto_discriminante_asserito_calci(C,F),1,'Individuata l''entita discriminante di calcio:'+C+' contenuta frase '+F).
explainer(entita_discriminante_asserita_pallavol(C,F),1,'Individuata l''entita discriminante di pallavolo:'+C+' contenuta frase '+F).
explainer(oggetto_discriminante_asserito_pallavol(C,F),1,'Individuata l''entita discriminante di pallavolo:'+C+' contenuta frase '+F).
explainer(entita_discriminante_asserita_baske(C,F),1,'Individuata l''entita discriminante di basket:'+C+' contenuta frase '+F).
explainer(oggetto_discriminante_asserito_baske(C,F),1,'Individuata l''entita discriminante di basket:'+C+' contenuta frase '+F).
explainer(entita_discriminante_asserita_tenni(C,F),1,'Individuata l''entita discriminante di tennis:'+C+' contenuta frase '+F).
explainer(oggetto_discriminante_asserito_tenni(C,F),1,'Individuata l''entita discriminante di tennis:'+C+' contenuta frase '+F).
explainer(entita_discriminante_asserita_formula_un(C,F),1,'Individuata l''entita discriminante di formula 1:'+C+' contenuta frase '+F).
explainer(oggetto_discriminante_asserito_formula_un(C,F),1,'Individuata l''entita discriminante di formula 1:'+C+' contenuta frase '+F).
explainer(entita_discriminante_asserita_nuot(C,F),1,'Individuata l''entita discriminante di nuoto:'+C+' contenuta frase '+F).
explainer(oggetto_discriminante_asserito_nuot(C,F),1,'Individuata l''entita discriminante di nuoto:'+C+' contenuta frase '+F).
explainer(entita_discriminante_asserita_motog(C,F),1,'Individuata l''entita discriminante di motogp:'+C+' contenuta frase '+F).
explainer(oggetto_discriminante_asserito_motog(C,F),1,'Individuata l''entita discriminante di motogp:'+C+' contenuta frase '+F).
explainer(relazione_spor(S,V,O),1,'Individuata la relazione di sport con soggetto '+S+' verbo '+V+' oggetto '+O).
