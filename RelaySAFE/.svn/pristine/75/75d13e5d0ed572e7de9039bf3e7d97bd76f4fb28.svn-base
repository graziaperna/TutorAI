...
public class RegexRuleComment {
	public static boolean isCommentRule(String regex) {
		...
		String re8 = "(r)"; // Any Single Character 8
		...
		if (m.find()) {
			//System.out.println("commento alla regola riconosciuto: " + regex);
			return true;
		} else
			//System.out.println("commento alla regola non riconosciuto");
		return false;
	}
}
